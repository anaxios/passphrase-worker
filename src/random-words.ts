...
class ConvertBase {
   ...
   * @param {function} [modifier=(x) => x] - An optional function to apply to each digit after conversion.
   */
...
/**
 * @typedef {Object} randomizer
 * @property {function(): Promise<number[]>} calculate
 */
/**
 * Represents a request for a random roll.
 *
 * This class encapsulates the randomizer used to generate a random roll.
 *
 * @class RequestRoll
 * @param {randomizer} randomizer - The randomizer object used to generate the roll.
 */
class RequestRoll {
  /**
   * Creates a new RequestRoll instance.
   *
   * @param {randomizer} randomizer - The randomizer object used to generate the roll.
   */
  ...
  /**
   * Calculates the result of the random roll.
   *
   * This method uses the provided randomizer to generate a random result.
   *
   * @async
   * @returns {Promise<number[]>} The result of the random roll.
   */
  async calculate() {
...
/**
 * Represents a passphrase generator.
 *
 * This class generates a passphrase by rolling random numbers and converting them to words.
 *
 * @class Passphrase
...
export class Passphrase {
  /**
   * Creates a new Passphrase instance.
   *
   * @param {number} count - The number of words in the passphrase.
   */
  ...
  /**
   * Generates a passphrase by rolling random numbers and converting them to words.
   *
   * This method uses the `RequestRoll` class to generate a random roll, converts the numbers to words using the `ConvertBase` class, and returns the resulting passphrase.
   *
   * @async
   * @returns {Promise<string>} The generated passphrase.
   */
  async roll() {
    const numbers = await new RequestRoll(
      this.api
    ).calculate();
